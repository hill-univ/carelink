                    ...
                    <form action="{{ route('admin.medicines.update', $medicine) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" 
                                    ...
                                    <option value="Cold & Flu" {{ old('category', $medicine->category) == 'Cold & Flu' ? 'selected' : '' }}>Cold & Flu</option>
                                    <option value="Digestive" {{ old('category', $medicine->category) == 'Digestive' ? 'selected' : '' }}>Digestive</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3" required>{{ old('description', $medicine->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('price') is-invalid @enderror" 
                                       id="price" name="price" value="{{ old('price', $medicine->price) }}" min="0" step="100" required>
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="requires_prescription" 
                                               id="requires_no" value="0" {{ old('requires_prescription', $medicine->requires_prescription) == '0' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="requires_no">No (OTC)</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="requires_prescription" 
                                               id="requires_yes" value="1" {{ old('requires_prescription', $medicine->requires_prescription) == '1' ? 'checked' : '' }}>
